...
---@param options (string|TermLabComboBoxOption)[] List of options
...
---})
---```
---@param columns string[]|TermLabAdvancedTable Column names (simple) or config table (advanced)
...
---@param id string Unique widget ID
---@param nodes TermLabTreeNode[] Tree node hierarchy
...
---@param items TermLabToolbarItem[] Toolbar items
...
---@param tabs TermLabTabPane[] Tab definitions
...
---@param fields TermLabFormField[] Form field definitions
...
---@class TermLabComboBoxOption
---@field value string Option value
---@field label string Display label

---@class TermLabTreeNode
...
---@field children? TermLabTreeNode[] Child nodes
---@field context_menu? TermLabContextMenuItem[] Right-click menu items

---@class TermLabContextMenuItem
...
---@class TermLabAdvancedTable
---@field id? string Table ID
---@field columns TermLabTableColumn[] Column definitions
---@field rows TermLabTableRow[] Row definitions
