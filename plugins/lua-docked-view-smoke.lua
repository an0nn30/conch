-- plugin-name: Docked View Smoke Test
-- plugin-description: Lua smoke test for docked plugin views and view-scoped widget events
-- plugin-version: 0.1.0
-- plugin-type: action
-- plugin-api: ^1.0
-- plugin-permissions: ui.menu, ui.panel, ui.dock, ui.notify

local ACTION_OPEN = "docked_view_smoke_open"
local ACTION_FOCUS = "docked_view_smoke_focus"
local ACTION_CLOSE = "docked_view_smoke_close"
local STABLE_VIEW_ID = "smoke"
...
function setup()
    app.register_command("Plugins", "Docked View Smoke: Open", ACTION_OPEN, nil)
    app.register_command("Plugins", "Docked View Smoke: Focus", ACTION_FOCUS, nil)
    app.register_command("Plugins", "Docked View Smoke: Close", ACTION_CLOSE, nil)
end
...
function render_view(view_id)
    ...
    ui.panel_heading("Docked View Smoke")
