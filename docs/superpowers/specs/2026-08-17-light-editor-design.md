...
**Superseded:** `2026-08-18-untitled-files-design.md` replaces the "scratches are real files" decision below with Notepad-style untitled buffers (in-memory, first save routes through the Save As dialog). The paragraph is kept for its historical rationale; it no longer describes current behavior.
