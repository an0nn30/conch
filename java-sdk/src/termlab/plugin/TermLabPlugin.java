...
/**
 * Interface that all TermLab Java plugins must implement.
 *
 ...
 * @see PluginInfo
 */
public interface TermLabPlugin {
     ...
     * Separator, and more. See the TermLab Plugin SDK documentation for the
