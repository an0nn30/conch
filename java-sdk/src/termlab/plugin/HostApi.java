...
/**
 * Host API for TermLab plugins.
 *
 * <p>Provides static methods that plugins call to interact with the TermLab
...
public class HostApi {
     ...
     *
     * <p>Messages appear in TermLab's log output (visible when running with
     ...
     *
     * <p>When the section is opened, TermLab requests plugin UI via
     ...
     * {@code ~/.config/termlab/plugins/<plugin-name>/<key>.json}.</p>
     *
     ...
     * {@link TermLabPlugin#onEvent(String)} receives it as a
