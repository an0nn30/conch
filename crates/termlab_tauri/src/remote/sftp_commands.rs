...
pub(super) fn get_ssh_handle(
    ...
    window_label: &str,
    pane_id: u32,
) -> Result<Arc<termlab_remote::russh::client::Handle<TermLabSshHandler>>, String> {
...
#[tauri::command]
pub(crate) fn local_list_dir(path: String) -> Result<Vec<termlab_remote::sftp::FileEntry>, String> {
    super::local_fs::list_dir(&path)
}

#[tauri::command]
pub(crate) fn local_stat(path: String) -> Result<termlab_remote::sftp::FileEntry, String> {
