(function initTermLabDialogRuntime(global) {
  function create(deps) {
    ...
    async function showAboutDialog() {
      ...
      title.textContent = 'About TermLab';
      ...
      heading.textContent = 'TermLab ' + esc(ver);
      ...
      position.textContent = 'TermLab unifies terminal, remote sessions, files, tunnels, credentials, and plugins in one cross-platform app.';
