...
(function (exports) {
  ...
  const settingsFeatureConstants = exports.termlabSettingsFeatureConstants || {};
  ...
  const settingsSectionsAppearance = exports.termlabSettingsSectionsAppearance || {};
  const settingsSectionsBasic = exports.termlabSettingsSectionsBasic || {};
  const settingsSectionsKeyboard = exports.termlabSettingsSectionsKeyboard || {};
  const settingsSectionsTerminal = exports.termlabSettingsSectionsTerminal || {};
  const settingsPluginsSection = exports.termlabSettingsPluginsSection || {};
  ...
  function invalidateCommandPaletteCache(reason) {
    if (typeof window.__termlabInvalidateCommandPaletteCache === 'function') {
      window.__termlabInvalidateCommandPaletteCache(reason || 'settings');
    }
  }
  ...
  function confirmPluginPermissions(pluginName, permissions) {
    if (window.termlabDialogService && typeof window.termlabDialogService.confirmPluginPermissions === 'function') {
      return window.termlabDialogService.confirmPluginPermissions(pluginName, permissions);
    }
    if (window.toast && typeof window.toast.error === 'function') {
