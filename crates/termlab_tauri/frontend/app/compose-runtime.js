(function initTermLabComposeRuntime(global) {
  function create(deps) {
    ...
    const initialState = global.termlabAppState && global.termlabAppState.createInitialState
      ? global.termlabAppState.createInitialState()
      : {
          tabs: new Map(),
          activeTabId: null,
          nextTabId: 1,
    ...
    const inputRuntime = global.termlabInputRuntime && global.termlabInputRuntime.create
      ? global.termlabInputRuntime.create()
      : { isTextInputTarget: () => false };

    const terminalRuntime = global.termlabTerminalRuntime && global.termlabTerminalRuntime.create
      ? global.termlabTerminalRuntime.create({
    ...
    const managerDelegates = global.termlabManagerDelegatesRuntime && global.termlabManagerDelegatesRuntime.create
      ? global.termlabManagerDelegatesRuntime.create()
      : {
          setPaneManager: () => {},
          setTabManager: () => {},
