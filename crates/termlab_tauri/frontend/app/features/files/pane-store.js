(function initTermLabFilesPaneStore(global) {
  'use strict';
  ...
  function getFollowPathFromSettings(settings) {
    return settings
      ...
      && typeof settings.termlab.files.follow_path === 'boolean'
      ? settings.termlab.files.follow_path
      : true;
  }
