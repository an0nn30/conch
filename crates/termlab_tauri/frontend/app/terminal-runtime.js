(function initTermLabTerminalRuntime(global) {
    ...
    function initTerminal(root) {
      ...
      term.attachCustomKeyEventHandler((event) => {
        if (isShortcutDebugEnabled() && shouldDebugKeyEvent(event)) {
          ...
          console.log(`[termlab-keydbg] xterm.customKeyEvent pane=${paneId}`, formatKeyEventForDebug(event));
        }
        return true;
      });
