...
// 'system' — callers that need "is the app dark right now" (there are none
// yet in this task) get a real answer instead of the mode string.
(function initTermLabAppearance(global) {
  ...
  global.termlabAppearance = { apply, current };
})(window);
