(function initTermLabBridgeRuntime(global) {
  function create(deps) {
    ...
    const clipboardRuntime = global.termlabClipboardRuntime && global.termlabClipboardRuntime.create
      ? global.termlabClipboardRuntime.create({
          invoke,
    ...
    const commandPaletteRuntime = global.termlabCommandPaletteRuntime && global.termlabCommandPaletteRuntime.create
      ? global.termlabCommandPaletteRuntime.create({
          invoke,
